...
# Science Direct
```{r}
science1<-bib2df(file = './articles/ScienceDirect_citations_1731876458350.bib')
dim(science1)
...
write.xlsx(data_articles_w_duplicates,'data/data_articles_w_duplicates_teste.xlsx')
